...
c.CourseDirectory.assignment_id = 'PS5'
...
#  line.
c.CourseDirectory.course_id = 'CSCI5622'
...
c.ClearSolutions.begin_solution_delimeter = '#BEGIN'

## The code snippet that will replace code solutions
c.ClearSolutions.code_stub = {'python': '#BEGIN \n# code here\n#END'}

## The delimiter marking the end of a solution
c.ClearSolutions.end_solution_delimeter = '#END'
...
c.ClearSolutions.text_stub = '%BEGIN\n\n% YOUR ANSWER HERE\n\n%END'
